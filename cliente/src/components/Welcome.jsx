...
const Welcome = ()=>{
    ...
    const {transactionCount, connectWallet, transactions, currentAccount,isLoading, sendTransaction, handleChange, formData} = useContext(TransactionContext);
        ...
        <div className='flex w-full justify-center items-center'>
            ...
            md:p-20 py-12 px-4'>
                <div className='flex flex-col flex-1 justify-start mf:mr-10'>
                    ...
                    {!currentAccount && (
                        <button type='button' onClick={connectWallet} className='flex flex-row justify-center items-center my-5 bg-[#2952e3] p-3 rounded-full cursor-pointer hover:bg-[#2546bd] text-white'>
                            Connect Wallet
                        </button>
                    ) }
                ...
                <div className='flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10'>
                    ...
                    <div className='p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism'>
                        ...
                        {isLoading ? (
                            ...
                            rounded-full cursor-pointer">Send Now</button>
                        )}
                    </div>
                </div>
            </div>
